#ifndef CCACHE_THIRD_PARTY_WIN32_ERRMAP_H_
#define CCACHE_THIRD_PARTY_WIN32_ERRMAP_H_

#include <errno.h>
#include <winerror.h>

// Adapted from: https://github.com/python/cpython/blob/v3.9.1/PC/errmap.h
inline int
